function [Z, Xcluster, A, cluster] = isodata_ND(X, k, L, I, ON, OC, OS, NO, min_dist)
...
% runs faster (almost 50x times faster than isodata.m) Its original name is wfIsodata_ND

% ON threshold number of elements for the elimination of a cluster.
% OC threshold distance for the union of clusters.
% OS deviation typical threshold for the division of a cluster.
% k number (maximum) cluster.
% L maximum number of clusters that can be mixed in a single iteration.
% I maximum number of iterations allowed.
% NO extra parameter to automatically answer no to the request of cambial any parameter.
% min_dist=50 Minimum distance a point must be in each center. If you want to delete any point Give a high value.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
while final==0,   %inicio del bucle de iteraciones.
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	%  3.Calculates and assigns each coordinate {X, Y} to its nearest center  %
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    primeravez=0;
	vuelve3=1;
% 	for i=1:s,
...
% 	end;
	...
	%  4.Remove  clusters  %
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	% Function to reduce (if necessary) the number of centers of found clusters.
	[Z, A, cluster]=eliminar(A, cluster, Z, X, ON);
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	%  5.Update the centers of the clusters  %
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	Z=recalcula(cluster, X, A, Z);
    
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	%  6.Finally, divide or merge clusters  %
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if (iter==I),
        final=1;
        next=0;
