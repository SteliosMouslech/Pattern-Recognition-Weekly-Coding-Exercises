...
ax.set_xlabel('Sepal Length (m)')
ax.set_ylabel('Sepal Width (m)')
ax.set_zlabel('Petal Length (m)')
...
ax2.set_xlabel('Sepal Length (m)')
ax2.set_ylabel('Sepal Width (m)')
ax2.set_zlabel('Petal Length (m)')
...
ax3.set_xlabel('Sepal Length (m)')
ax3.set_ylabel('Sepal Width (m)')
ax3.set_zlabel('Petal Length (m)')
...
ax4.set_xlabel('Sepal Length (m)')
ax4.set_ylabel('Sepal Width (m)')
ax4.set_zlabel('Petal Length (m)')
